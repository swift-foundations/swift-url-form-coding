...
struct BoolStrategyTests {
    ...
    struct EncodingTests {
        ...
        func testExplicitTrueFalseStrategy() throws {
            let encoder = HTML.Form.Coder.Encoder(boolEncodingStrategy: .trueFalse)
        ...
        func testYesNoStrategy() throws {
            let encoder = HTML.Form.Coder.Encoder(boolEncodingStrategy: .yesNo)
    ...
    struct DecodingTests {
        ...
        func testExplicitTrueFalseStrategyDecoding() throws {
            let decoder = HTML.Form.Coder.Decoder(boolDecodingStrategy: .trueFalse)
        ...
        func testYesNoStrategyDecoding() throws {
            let decoder = HTML.Form.Coder.Decoder(boolDecodingStrategy: .yesNo)
